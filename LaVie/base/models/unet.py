...
if __name__ == '__main__':
    ...
    pretrained_model_path = "../../pretrained/stable-diffusion-v1-4/" # p cluster
    import os
    
    print("pretrained_model_path : ", pretrained_model_path, os.path.exists(pretrained_model_path))
    print(os.path.exists(pretrained_model_path))
